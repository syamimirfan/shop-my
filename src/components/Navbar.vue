    ...
    <div class="container flex items-center justify-between h-20">
      <a @click="showMenu = false" href="#home">
        <div class="relative z-30 flex items-center gap-2 mb-2 lg:mb-0">
          <h1 class="text-white font-bold text-lg lg:text-2xl">Shop<span class="text-secondary">My</span></h1>
          <svg width="20" height="16" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Customized shop building icon -->
            <path d="M2 10H4V7H2V10ZM6 10H8V7H6V10ZM10 10H12V7H10V10ZM14 10H16V7H14V10ZM16 6H2L1 12H17L16 6Z" fill="white"/>
        </svg>
      ...
      >
        ...
        <button class="hidden md:block px-8 py-3 rounded-full text-white font-medium tracking-wider uppercase bg-secondary w-full lg:w-auto">Login</button>
      </div>
    </div>
  </nav>
</template>